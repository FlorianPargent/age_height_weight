...
However, the pattern was different the weight and age scales, where several items loaded substantially higher on the latent variable than the physical items:
