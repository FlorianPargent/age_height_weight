...
table2 <- rbind(
  ...
  flextable::bold(i = ~ age_6 > age_6[14], j = "age_6") |>
  flextable::bold(i = ~ age_2 > age_2[14], j = "age_2") |>
  flextable::bold(i = ~ height_6 > height_6[14], j = "height_6") |>
  flextable::bold(i = ~ height_2 > height_2[14], j = "height_2") |>
  flextable::bold(i = ~ weight_6 > weight_6[14], j = "weight_6") |>
  flextable::bold(i = ~ weight_2 > weight_2[14], j = "weight_2") |>
...
table3 <- load_df_bifac_proc |> 
  ...
  flextable::bold(i = ~ age_age > 0.6, j = "age_age") |>
  flextable::bold(i = ~ age_Alter_realW > 0.6, j = "age_Alter_realW") |>
  flextable::bold(i = ~ age_Geschlecht > 0.6, j = "age_Geschlecht") |>
  flextable::bold(i = ~ height_height > 0.6, j = "height_height") |>
  flextable::bold(i = ~ height_Koerpergroesse_realW > 0.6, j = "height_Koerpergroesse_realW") |>
  flextable::bold(i = ~ height_Geschlecht > 0.6, j = "height_Geschlecht") |>
  flextable::bold(i = ~ weight_weight > 0.6, j = "weight_weight") |>
  flextable::bold(i = ~ weight_Koerpergewicht_realW > 0.6, j = "weight_Koerpergewicht_realW") |>
  flextable::bold(i = ~ weight_Geschlecht > 0.6, j = "weight_Geschlecht") |>
...
(r_real_poly <- corx(data = dat_poly |>
  ...
  method = "pearson", stars = c(0.05, 0.01, 0.001)))
...
cor_table <- tribble(
  ...
  "Weight", r_real_GGe2, r_real_GGe6, rel_Ge2      , rel_Ge6      , r_latent_AGe2, r_latent_AGe6,
  "Age"   , r_real_AG2 , r_real_AG6 , r_real_AGe2  , r_real_AGe6  , rel_A2       , rel_A6      
)
```
