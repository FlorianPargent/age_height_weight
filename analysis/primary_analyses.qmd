...
# ---- Alter ----
loadings1 <- get_std_loadings(fit1A6P, "age 1")
loadings2 <- get_std_loadings(fit1A2P, "age d1")
all_loadings12 <- bind_rows(loadings1, loadings2)

table_loadings12 <- all_loadings12 %>%
  pivot_wider(names_from = model, values_from = est.std)

print(table_loadings12)

# ---- Größe ----
loadings3 <- get_std_loadings(fit1G6P, "height 2")
loadings4 <- get_std_loadings(fit1G2P, "height d2")
all_loadings34 <- bind_rows(loadings3, loadings4)

table_loadings34 <- all_loadings34 %>%
  pivot_wider(names_from = model, values_from = est.std)

print(table_loadings34)

# ---- Gewicht ----
loadings5 <- get_std_loadings(fit1Ge6P, "weight 3")
loadings6 <- get_std_loadings(fit1Ge2P, "weight d3")
all_loadings56 <- bind_rows(loadings5, loadings6)

table_loadings56 <- all_loadings56 %>%
  pivot_wider(names_from = model, values_from = est.std)

print(table_loadings56)
```
